# The Condo Book Project - product rubric

Goal: Help NYC developers find a relevant condo offering plan, understand what the filing actually supports, and reach the source document quickly.

Judge usefulness, factual precision, coverage transparency, navigation and visual clarity together. A polished result that implies an unsupported fact is a failure.

- The centered search bar is the home page's primary action.
...
Out of scope: login, accounts, payments, and new data sources.
